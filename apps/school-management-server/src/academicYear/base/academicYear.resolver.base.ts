...
export class AcademicYearResolverBase {
  ...
  @graphql.ResolveField(() => [Term], { name: "terms" })
  async findTerms(
    @graphql.Parent() parent: AcademicYear,
    @graphql.Args() args: TermFindManyArgs
  ): Promise<Term[]> {
    const results = await this.service.findTerms(parent.id, args);
