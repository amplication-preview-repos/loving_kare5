...
class AcademicYearCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TermCreateNestedManyWithoutAcademicYearsInput,
  })
  @ValidateNested()
  @Type(() => TermCreateNestedManyWithoutAcademicYearsInput)
  @IsOptional()
  @Field(() => TermCreateNestedManyWithoutAcademicYearsInput, {
    nullable: true,
  })
...
export { AcademicYearCreateInput as AcademicYearCreateInput };
